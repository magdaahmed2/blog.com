          ...
          <div class="card-body">
            ...
            <form action="" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputText" value="{{old('slug')}}" required name="slug">
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputText" value="{{old('title')}}" required name="title">
                </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputText" value="{{old('meta_title')}}"
                   name="meta_title">
                </div>
